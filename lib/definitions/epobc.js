...
/*
JSUtil.defineGetter(EPOBCColorDefinition, 'code', function () {
  return 'epobc'
})

JSUtil.defineGetter(EPOBCColorDefinition.prototype, 'desc', function () {
  var items = [
    'epobc',
    this._genesis.txId,
...
EPOBCColorDefinition.makeComposedTx = function (operationalTx) {
  ...
  return Promise.try(function () {
    targetsByColor = ColorTarget.groupTargetsByColor(operationalTx.getTargets(), EPOBCColorDefinition)
