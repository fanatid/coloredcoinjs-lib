...
function (tx, oidxs, cdefCls, getTxFn) {
  var self = this
  ...
  if (process === undefined) {
    ...
    process = self._storage.get(opts)
      .then(function (data) {
        ...
        .then(function (rows) {
          // update oidxs
          var oidxsTodo = _.difference(oidxs, _.keys(data).map(function (value) {
            return parseInt(value, 10)
          }))
          return [rows, oidxsTodo]
        })
            ...
            return Promise.map(inputss, function (inputs) {
              return getTx(inputs[0].txid)
                .then(function (rawtx) {
                  ...
                  return self._getColorOutputsOrScan(
 ...
 */
/* @todo add opts.save */
ColorData.prototype.getTxColorValues = function (tx, oidxs, cdefCls, getTxFn) {
  var self = this
  return Promise.try(function () {
    if (oidxs === null) {
...
function (tx, oidx, cdefCls, getTxFn) {
  return this._getColorOutputsOrScan(tx, [oidx], cdefCls, getTxFn)
    .then(function (rows) {
